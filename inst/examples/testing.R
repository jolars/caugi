...
#
# # add a new glyph
# code <- edge_registry_register(reg, "--<", "line", "arrow", "left_head", "directed", FALSE, TRUE)
...
# try(edge_registry_register(reg, "-->", "line", "arrow", "right_head", "undirected", TRUE, TRUE))
#
# # sealing prevents further changes
# edge_registry_seal(reg)
# try(edge_registry_register(reg, "o-O", "circle", "other", "right_head", "partial", FALSE, TRUE))
