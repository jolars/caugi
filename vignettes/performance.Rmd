...
microbenchmark(
  ...
  # using node name (same as index here, but slower)
  caugi_neighbors_parsed = caugi::neighbors(cg, "50"),
  caugi_parents_parsed = caugi::parents(cg, "50"),
  caugi_children_parsed = caugi::children(cg, "50"),
