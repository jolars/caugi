...
The circle layout places nodes evenly along the perimeter of a circle. The
first node is placed at the top and subsequent nodes proceed counter-clockwise.
Edge structure is ignored, so the layout is the same for any graph with the
