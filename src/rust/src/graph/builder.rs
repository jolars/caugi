...
pub struct GraphBuilder {
    ...
    undirs_unknowns: Vec<Vec<HalfEdge>>,
...
impl GraphBuilder {
    ...
    pub fn new_with_registry(n: u32, simple: bool, reg: &EdgeRegistry) -> Self {
        ...
        Self {
            ...
            undirs_unknowns: vec![Vec::new(); n_us],
    ...
    fn push_half(&mut self, from: u32, to: u32, etype: u8, side_bit: u8, spec: &EdgeSpec) {
        ...
        let bucket = match role {
            ...
            Role::Undirected => &mut self.undirs_unknowns,
    ...
    pub fn finalize(mut self) -> Result<CaugiGraph, String> {
        ...
        let undirs_unknowns = std::mem::take(&mut self.undirs_unknowns);
        let children = std::mem::take(&mut self.children);
        let seen = std::mem::take(&mut self.seen);
        let _pair = std::mem::take(&mut self.pair_seen);
        self.build_from_parts(parents, undirs_unknowns, children, seen)
    }
    ...
    fn build_from_parts(
        ...
        mut undirs_unknowns: Vec<Vec<HalfEdge>>,
        ...
        for i in 0..n {
            ...
            let u = undirs_unknowns[i].len() as u32;
        ...
        // Fill COL_INDEX, ETYPE, SIDE in order: parents | undirs_unknowns | children.
        ...
        for i in 0..n {
            ...
            for h in &undirs_unknowns[i] { col[k]=h.nbr; ety[k]=h.etype; side[k]=h.side; k+=1; }
