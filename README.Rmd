...
If you don't have Rust installed, please install `rustc >= 1.80.0` or higher from:
...
You can create simple graphs as well as a number of predefined graph classes. Currently, we support `"UNKNOWN"`, `"DAG"`, `"PDAG"`, and `"UG"`. We plan on supporting several other causal graph types in future releases, such as `"PAG"`, `"MAG"`, `"SWIG"`, and `"ADMG"`.
